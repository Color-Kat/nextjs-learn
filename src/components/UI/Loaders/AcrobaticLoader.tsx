...
export const AcrobaticLoader: React.FC<LoaderProps> = memo(({className}) => {
    return (
        ...
        >
            ...
            <circle className="acrobatic-loader__ring" r="56" cx="64" cy="192" fill="none" stroke="#ddd"
                    strokeWidth="16"
                    strokeLinecap="round"/>
            <circle className="acrobatic-loader__worm1" r="56" cx="64" cy="192" fill="none"
                    stroke="url(#acrobatic-loader-grad1)" strokeWidth="16"
                    strokeLinecap="round" strokeDasharray="87.96 263.89"/>
            <path className="acrobatic-loader__worm2"
